...
You can download the latest sample app [here](https://github.com/rubengees/EasyHeaderFooterAdapter/releases/download/1.0.3/sample-release.apk).
...
```groovy
dependencies {
    compile 'com.github.rubengees:EasyHeaderFooterAdapter:1.0.3@aar'
}
```
...
You can find the JavaDoc [here](https://jitpack.io/com/github/rubengees/EasyHeaderFooterAdapter/1.0.3/javadoc/).
